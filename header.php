<header class="header d-flex align-items-center" data-page="home">
    <div class="container position-relative d-flex justify-content-between align-items-center">
        <a class="brand d-flex align-items-center" href="index.php">
            ...
            <span class="brand_name">MamaMoon</span>
        </a>
            ...
            <nav class="header_nav">
                <ul class="header_nav-list">
                    ...
                    <li class="header_nav-list_item dropdown">
                        <a class="nav-link dropdown-toggle d-inline-flex align-items-center" href="rooms.php" data-bs-toggle="collapse" data-bs-target="#roomMenu" aria-expanded="false" aria-controls="roomMenu" data-page="rooms">
                            Rooms
                    ...
                    <li class="header_nav-list_item dropdown">
                        <a class="nav-link dropdown-toggle d-inline-flex align-items-center" href="news.php" data-bs-toggle="collapse" data-bs-target="#newsMenu" aria-expanded="false" aria-controls="newsMenu" data-page="news">
                            News
                            <i class="icon-chevron_down--entypo icon"></i>
                        </a>
                        <div class="dropdown-menu collapse" id="newsMenu">
                            <ul class="dropdown-list">
                                ...
                                <li class="list-item">
                                    <a class="dropdown-item nav-item" data-page="post" href="post.php">Single post</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="header_nav-list_item dropdown">
                        ...
                        <div class="dropdown-menu collapse" id="pagesMenu">
                            <ul class="dropdown-list">
                                ...
                                <li class="list-item">
                                    <a class="dropdown-item nav-item" data-page="error02" href="404.php">Error Page V2</a>
                                </li>
                            </ul>
                        </div>
                    </li>
