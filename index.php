    ...
    <main>
        ...
        <section class="hero section">
            <div class="container container--hero d-lg-flex align-items-center justify-content-between">
                <div class="hero_main">
                    <h1 class="hero_main-title" data-aos="fade-up"><?php echo $titre ?></h1>
                ...
                <div class="hero_media" data-aos="zoom-in">
                    <picture>
                        <source data-srcset="img/hostel3.jpg" srcset="img/hostel3.jpg" />
                        <img class="lazy" data-src="img/hostel3.jpg" src="img/hostel3.jpg" alt="media" />
                    </picture>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <ul class="rooms_list d-md-flex flex-wrap">
                    <?php foreach ($rooms as $room) { ?>
                        <li class="rooms_list-item col-md-6 col-xl-4" data-order="<?php echo $room['order'] ?>" data-aos="fade-up">
                            <div class="item-wrapper d-md-flex flex-column">
                                <div class="media">
                                    <picture>
                                        <source data-srcset="<?php echo $room['image'] ?>" srcset="<?php echo $room['image'] ?>" />
                                        <img class="lazy" data-src="<?php echo $room['image'] ?>" src="<?php echo $room['image'] ?>" alt="media" />
                                    </picture>
                                    <span class="media_label media_label--pricing">
                                        <span class="price h4"><?php echo $room['price'] ?></span>
                                        / <?php echo $room['unit'] ?>
                                    </span>
                                </div>
                                <div class="main d-md-flex flex-column justify-content-between flex-grow-1">
                                    <a class="main_title h4" href="room.php" data-shave="true"><?php echo $room['title'] ?></a>
                                    <div class="main_amenities">
                                        <span class="main_amenities-item d-inline-flex align-items-center">
                                            <i class="icon-user icon"></i>
                                            <?php echo $room['sleeps'] ?>
                                        </span>
                                        <span class="main_amenities-item d-inline-flex align-items-center">
                                    ...
                                    <a class="link link--arrow d-inline-flex align-items-center" href="<?php echo $room['availability'] ?>">
                                        See availability
        ...
        <section class="about section">
            <div class="container container--about d-xl-flex align-items-center">
                ...
                <div class="about_media" data-aos="zoom-in">
                    ...
                    <video id="homeVideo" autoplay controls height="100%">
            ...
            <div class="container">
                ...
                <div class="gallery_grid d-grid">
                    <?php foreach ($pictures as $picture) { ?>
                        <div class="gallery_grid-item gallery_grid-item--<?php echo $picture['className'] ?>" data-aos="zoom-in">
                            <a href="<?php echo $picture['image'] ?>" data-caption="Image caption" data-role="gallery-link">
                                <picture>
                                    <source data-srcset="<?php echo $picture['image'] ?>" srcset="<?php echo $picture['image'] ?>" />
                                    <img class="gallery_grid-item_img lazy" data-src="<?php echo $picture['image'] ?>" src="<?php echo $picture['image'] ?>" alt="media" />
                                </picture>
                    ...
                    <!-- <div class="gallery_grid-item" data-aos="zoom-in">
                        <a href="img/placeholder.jpg" data-caption="Image caption" data-role="gallery-link">
                            <picture>
                                <source data-srcset="img/placeholder.jpg" srcset="img/placeholder.jpg" />
                                <img class="gallery_grid-item_img lazy" data-src="img/placeholder.jpg" src="img/placeholder.jpg" alt="media" />
                            </picture>
                            <div class="overlay d-flex align-items-center justify-content-center">
                                <div class="overlay_focus">
                                    <svg width="105" height="106" viewBox="0 0 105 106" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- <section class="latest section section--blockbg">
            ...
            <div class="container">
                <div class="latest_header d-sm-flex justify-content-between align-items-center">
                    ...
                    <div class="wrapper" data-aos="fade-left">
                        <a class="btn theme-element theme-element--light" href="news.php">View all news</a>
                    </div>
                </div>
